...
@section('main-content')
    ...
    <section class="shop checkout section">
        <div class="container">
            <form class="form" method="POST" action="{{ route('cart.order') }}" id="payment_form">
                @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="first_name" placeholder="" value="{{ old('first_name') ?? Auth::user()->name}}"
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address1" placeholder="" value="{{ old('address1') ?? Auth::user()->address }}">
                                        @error('address1')
                                            <span class='text-danger'>{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="content">
                                    <ul>
                                        <li class="order_subtotal" data-price="{{ Helper::totalCartPrice() }}">Cart
                                            Subtotal<span>R.s{{ number_format(Helper::totalCartPrice(), 2) }}</span></li>

                                        @if (session('coupon'))
                                            <li class="coupon_price" data-price="{{ session('coupon')['value'] }}">You
                                                Save<span>R.s{{ number_format(session('coupon')['value'], 2) }}</span></li>
                                        @endif
                                        @php
                                        ...
                                        @if (session('coupon'))
                                            <li class="last" id="order_total_price">
                                                Total<span>R.s{{ number_format($total_amount, 2) }}</span></li>
                                        @else
                                            <li class="last" id="order_total_price">
                                                Total<span>R.s{{ number_format($total_amount, 2) }}</span></li>
                                        @endif
                                ...
                                <div class="content">
                                    <div class="checkbox">
                                        ...
                                        <div class="form-group" id="stripe" >
                                            ...
                                            <div id="card-element" class="p-3 bg-white rounded"
                                                style="box-shadow:0 2.8px 2.2px rgb(74 73 73 / 21%)">
                                                <!-- A Stripe Element will be inserted here. -->
                                            </div>

                                            <!-- Used to display form errors. -->
                                            <div id="card-errors" class="text-danger" role="alert">
                                                @error('cardnumber') <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                            </div>
