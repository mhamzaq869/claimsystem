									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="product-buy">
												...
												<p class="cat">Category :<a href="{{route('product-cat',$product_detail->slug)}}">{{$product_detail->title}}</a></p>
															...
															<div class="col-12">
																...
																<div class="comment-review">
																	...
																	<div class="review-inner">
																			<!-- Form -->
																@auth
                                                                @if(Auth::user()->cart->where('order_id','!=',null)->where('product_id',$product_detail->id)->first())
                                ...
                                <div class="single-product">
                                    <div class="product-img">
										<a href="{{route('product-detail',$data->slug)}}">
											...
											@endphp
                                            <img class="default-img" src="{{asset($photo[0])}}" alt="{{$data->slug}}">
