 ...
 {{-- <div class="card shadow mb-4"> --}}
    ...
    <div class="row mt-2">
        <div class="col-md-8 col-6">
            <h6 class="m-0 font-weight-bold display-4 float-left">Product Lists</h6>
        </div>
    ...
    {{-- <div class="card-body"> --}}
      <div class="table-responsive">
                    ...
                    <td>
                        @if($product->photo)
                            ...
                            @foreach ($photos as $i => $photo)
                                 <img src="{{asset($photo)}}" class="img-fluid zoom" style="max-width:80px" alt="{{asset($photo)}}">
                            @endforeach
                        @else
        ...
        @else
          <h6 class="text-center mt-5">No Products found!!! Please create Product</h6>
        @endif
      </div>
    {{-- </div> --}}
{{-- </div> --}}
