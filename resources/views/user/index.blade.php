...
@section('main-content')
    <div class="container-fluid">
        ...
        @if (Auth::user()->role == 'user')
                ...
                <div class="col-xl-6 col-md-6 mb-4 shadow-sm">
                    <div class="card border-left-success border-right-0 h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Purchased Items
                                    </div>
                                    ...
                                    <tbody>
                                        @foreach ($projects as $key => $project)
                                            <tr>
                                                ...
                                                <td><button onclick="doChat({{ $project->id }})"
                                                        class="badge badge-success text-center"
                                                        style="padding: 14px 15px;border-radius: 50%;">{{ App\Models\Bid::where('project_id', $project->id)->count() }}</button>
                                                </td>
            ...
            <!-- Modal -->
            <div class="modal fade" id="boy" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
                aria-hidden="true">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">
                                <h4>Active Orders - <span
                                        class="text-secondary">{{ $contract->count() }}(${{ $contract->pluck('price')->sum() * 0.8 }})</span>
                                    </h1>
                            </div>
                        </div>
                    </div>
        ...
        @if (!empty($dboy) && $dboy != null)
            @if (!isset($_COOKIE['close']))
                <!-- Modal -->
                <div class="modal fade" id="dboy" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
                    aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                        <div class="modal-content">
                                    ...
                                    <div class="card mt-2">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div>
                                                        <p> <i class="fa fa-phone-alt"></i> {{ $boy->phone ?? 'N/A' }}
                                                        </p>
                                                    </div>
                                                    <div>
