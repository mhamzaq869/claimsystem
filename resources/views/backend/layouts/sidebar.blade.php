<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Categories -->
    <li class="nav-item">
        <a class="nav-link collapsed" href="{{ route('admin.view.projects') }}">
            <i class="fas fa-sitemap"></i>
            <span>Project</span>
        </a>
        {{-- <div id="categoryCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    ...
    {{-- Products --}}
    <li class="nav-item">
        <a class="nav-link collapsed" href="{{ route('admin.view.bids') }}">
            <i class="fas fa-cubes"></i>
            <span>Bids</span>
        </a>
        {{-- <div id="productCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    ...
    {{-- Brands --}}
    <li class="nav-item">
        <a class="nav-link collapsed" href="{{ route('admin.view.contracts') }}">
            <i class="fas fa-table"></i>
            <span>Contract</span>
        </a>
        {{-- <div id="brandCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    ...
    <!-- Categories -->
    <li class="nav-item">
        <a class="nav-link collapsed" href="{{ route('admin.payment.request') }}">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="{{ route('admin.payment.trans') }}">
